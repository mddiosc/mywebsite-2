...
const ProjectsEmptyState = () => {
  ...
  return (
    <div className="mt-12 flex flex-col items-center justify-center rounded-lg border-2 border-dashed border-gray-300 p-12 text-center">
      ...
      <h3 className="mt-2 text-sm font-medium text-gray-900">{t(TRANSLATION_KEYS.EMPTY.TITLE)}</h3>
      <p className="mt-1 text-sm text-gray-500">{t(TRANSLATION_KEYS.EMPTY.MESSAGE)}</p>
    </div>
  )
}
