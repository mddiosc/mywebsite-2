const ProjectSkeleton = () => {
  return (
    <div className="group relative flex h-full animate-pulse flex-col overflow-hidden rounded-lg border border-gray-200 bg-white dark:border-gray-700 dark:bg-gray-900">
      {/* Image skeleton */}
      <div className="aspect-h-4 aspect-w-3 sm:aspect-none bg-gray-200 sm:h-48 dark:bg-gray-700">
        <div className="flex h-full w-full items-center justify-center bg-linear-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-700">
          <div className="h-16 w-16 rounded bg-gray-300 dark:bg-gray-600"></div>
        </div>
      </div>
        ...
        <div className="mt-4 flex flex-1 flex-col justify-between">
          <div className="flex flex-col gap-3">
            ...
            <div className="h-16">
              <div className="flex flex-wrap gap-1">
                {[1, 2, 3].map((tag) => (
                  <div key={tag} className="h-6 w-16 rounded-md bg-gray-300 dark:bg-gray-600"></div>
                ))}
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="h-7 w-16 rounded-md bg-gray-300 dark:bg-gray-600"></div>
            </div>
          </div>
        </div>
      </div>
