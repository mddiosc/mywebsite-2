  ...
  return (
    <div className="py-12">
      <div className="text-center">
        {/* Spinner with primary colors and dark mode */}
        <div className="mx-auto mb-4 h-12 w-12 animate-spin rounded-full border-4 border-primary/20 border-t-primary dark:border-primary/30 dark:border-t-primary" />
      ...
      <div className="mt-8 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
        {Array.from({ length: 6 }, () => crypto.randomUUID()).map((id) => (
          <div
            key={id}
            className="group relative flex h-full animate-pulse flex-col rounded-2xl border border-gray-200/50 bg-white/80 backdrop-blur-sm dark:border-gray-700/50 dark:bg-gray-900/80"
          >
            {/* Header skeleton with gradient background */}
            <div className="aspect-h-3 aspect-w-4 sm:aspect-none overflow-hidden rounded-t-2xl bg-gray-200 sm:h-40 dark:bg-gray-800">
